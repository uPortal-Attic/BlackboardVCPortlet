...
<div id="${n}" class="blackboardVCRoot">
	...
	<div class="uportal-channel-subtitle"><spring:message code="serverInformation" text="serverInformation"/></div>
	...
	<div class="uportal-channel-subtitle" style="padding-top: 1em; padding-bottom: 1em;"><spring:message code="serverQuota" text="serverQuota"/></div>
	...
	<div class="uportal-channel-subtitle" style="padding-top: 1em; padding-bottom: 1em;"><spring:message code="adminActions" text="adminActions" /></div>
