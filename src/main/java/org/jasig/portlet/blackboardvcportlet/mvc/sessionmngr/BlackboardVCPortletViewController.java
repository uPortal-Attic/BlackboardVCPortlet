   ...
   // private PortletPreferences prefs;
    ...
    public ModelAndView view(RenderRequest request, RenderResponse response) {
        ...
        displayName=userInfo.get("displayName");
         if (userInfo.get("mail")!=null&&!userInfo.get("mail").equals(""))
         {
        ...
        this.logger.debug("eduPersonAffiliation:"+eduPersonAffiliation);
        this.logger.debug("eduPersonOrgUnitDN:"+eduPersonOrgUnitDn);
