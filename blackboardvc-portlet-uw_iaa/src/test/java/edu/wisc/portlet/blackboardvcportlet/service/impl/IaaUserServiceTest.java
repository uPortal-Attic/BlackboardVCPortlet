...
public class IaaUserServiceTest {
    ...
    public void testSearchByFirstName() {
        ...
        verify(jdbcOperations).query(
                eq("select EPPN, FIRST_NAME, MIDDLE_NAME, LAST_NAME, NAME_PRIVATE, EMAIL_ADDRESS, EMAIL_PRIVATE from iaaviews.portal_blackboard_lookup where upper(first_name) like upper(?) OR upper(last_name) like upper(?) OR upper(FIRST_NAME || ' ' || MIDDLE_NAME || ' ' || LAST_NAME) like ?"), 
                any(RowMapper.class), 
                eq("John%"),
                eq("John%"),
                eq("John%"));
    ...
    public void testSearchByFirstLastName() {
        ...
        verify(jdbcOperations).query(
                eq("select EPPN, FIRST_NAME, MIDDLE_NAME, LAST_NAME, NAME_PRIVATE, EMAIL_ADDRESS, EMAIL_PRIVATE from iaaviews.portal_blackboard_lookup where (upper(first_name) like upper(?) AND upper(last_name) like upper(?)) OR upper(FIRST_NAME || ' ' || MIDDLE_NAME || ' ' || LAST_NAME) like ?"), 
                any(RowMapper.class), 
                eq("John%"),
                eq("Doe%"),
                eq("John%Doe%"));
    ...
    public void testSearchByEmail() {
        ...
        verify(jdbcOperations).query(
                eq("select EPPN, FIRST_NAME, MIDDLE_NAME, LAST_NAME, NAME_PRIVATE, EMAIL_ADDRESS, EMAIL_PRIVATE from iaaviews.portal_blackboard_lookup where upper(EMAIL_ADDRESS) like upper(?)"), 
                any(RowMapper.class), 
                eq("john.doe@example%"));
    }
    ...
    public void testFindUser() {
        ...
        verify(jdbcOperations).query(
                eq("select EPPN, FIRST_NAME, MIDDLE_NAME, LAST_NAME, NAME_PRIVATE, EMAIL_ADDRESS, EMAIL_PRIVATE from iaaviews.portal_blackboard_lookup where EPPN = ?"), 
                any(RowMapper.class), 
                eq("ID"));
    }
